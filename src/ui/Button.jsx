...
const Button = ({ children, disabled, to, type }) => {
  const base =
    "inline rounded-full bg-yellow-400 font-semibold uppercase tracking-widest text-stone-800 transition-colors duration-300 hover:bg-yellow-300 focus:bg-yellow-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed";
